...
module Auth = {
  ...
  type sessionContextValue = {
    data: Js.Nullable.t<session>,
    status: status,
  }

  module SessionProvider = {
    @module("next-auth/react") @react.component
    external make: (~session: session=?, ~children: React.element) => React.element =
      "SessionProvider"
  }

  @module("next-auth/react")
  external useSession: unit => sessionContextValue = "useSession"

  @module("next-auth/react")
  external getSession: CtxOrReq.t => Js.Promise.t<Js.Nullable.t<session>> = "getSession"

  @module("next-auth/react")
  external signIn: 'a => unit = "signIn"

  @module("next-auth/react")
  external signOut: 'a => unit = "signOut"
}
